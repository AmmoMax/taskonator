...
from src.domains.main.adapter.output.db_models import Base
from src.domains.command.configuration import DBConfig
from src.domains.main.adapter.output.db_tools import create_database_schema
...
version_table_schema = db_config.POSTGRES_SCHEMA_NAME

engine = create_engine(db_config.postgres_url)
create_database_schema(engine, version_table_schema)
